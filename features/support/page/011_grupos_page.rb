class GruposPage < PageHelper
    ...
    element :btn_editar, :xpath, :xpath, '//*[@id="edit"]'
    element :btn_deletar, :xpath, :xpath, '//*[@id="deletetooltip"]'
    ...
    def informar_nome_consulta
        ...
        input_nome.set("grupo Teste Automatizado")
    end


   def informar_nome
       puts "setar o nome do usuario"
       input_profile_nome.set("grupo Teste Automatizado")
   end
    ...
    def alterar_dados_grupo
        ...
        input_agente.set("Barros Agente")
        sleep 2
        input_agente.send_keys(:enter)
        input_gestor.set("Wesley Barros")
        sleep 2
        input_gestor.send_keys(:enter)
